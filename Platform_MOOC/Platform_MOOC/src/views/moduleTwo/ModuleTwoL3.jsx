...
const ModuleTwoL3 = () => {
    ...
    const handleModuleTwoQuizL3Click = () => {
        navigate('/ModuleTwoQuizL3');
    };
    const goToYoutubeL3 = () => {
        window.location.href = 'https://youtu.be/IMhrNpOVsSc?feature=shared';
    };
    ...
    const youtubeCard = () => {
        return (
            <>
                <div className="card" onClick={goToYoutubeL3}>
    ...
    const quizCard = () => {
        return (
            <>
                ...
                <div onClick={handleModuleTwoQuizL3Click} className="card">
        ...
        <>
            <div className="content-module-two">
                ...
                <div className="video-container">
                    ...
                    <iframe
                        src="https://www.youtube.com/embed/IMhrNpOVsSc?si=dNslxRc8X26QCQVC"
                        frameBorder="0"
                        allowFullScreen
                    ></iframe>
                </div>
                ...
                <div className="chapter-description">
                    ...
                    <div className="chapter-two-description-content" >
                        ...
                        <h1 className="module-two-selected-chapter">Lesson 3: Social Responsibility and Sustainability</h1>
